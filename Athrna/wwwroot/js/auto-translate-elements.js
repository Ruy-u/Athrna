...
<div class="city-header" data-city-name="@Model.City.Name">
    <div class="city-overlay"></div>
    <h1 data-translate="city-title">Explore @Model.City.Name</h1>
    <p data-translate="city-subtitle">Discover the rich historical heritage of @Model.City.Name</p>
</div>

<div class="container mt-5">
    <!-- Historical Sites Section -->
    <section class="sites-section">
        <h2 data-translate="Historical Sites in">Historical Sites in @Model.City.Name</h2>
                ...
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="site-card" data-site-id="@site.Id">
                        ...
                        <div class="site-content">
                            <h3 class="site-name" data-translate="site-name-@site.Id">@site.Name</h3>
                            <p class="site-type"><span data-translate="site-type-@site.Id">@site.SiteType</span></p>
                            <p class="site-description" data-translate="site-description-@site.Id">@site.Description.Substring(0, Math.Min(150, site.Description.Length))...</p>
                            <div class="site-metadata">
                                @if (site.CulturalInfo != null)
                                {
                                    <p class="site-established">
                                        <i class="bi bi-calendar"></i> <span data-translate="Established">Established</span>: @site.CulturalInfo.EstablishedDate
                                    </p>
                                }
                            </div>
                            <a asp-action="Site" asp-route-id="@site.Id" class="btn btn-primary mt-3" data-translate="Explore Site">Explore Site</a>
                        </div>
                    </div>
                </div>
            }
                ...
                <div class="col-md-6 col-lg-3 mb-4">
                    <div class="guide-card">
                        <div class="guide-avatar">
                            <img src="/api/placeholder/150/150" alt="@guide.FullName" class="rounded-circle">
                        </div>
                        <div class="guide-content">
                            ...
                            <button class="btn btn-outline-primary btn-sm mt-2" data-translate="Contact Guide">Contact Guide</button>
                        </div>
                    </div>
                </div>
            }
    ...
    <section class="map-section mt-5">
        <h2 data-translate="Interactive Map of">Interactive Map of @Model.City.Name</h2>

        <div class="map-container">
            <div id="cityMap" class="city-map">
                <!-- Map will be loaded via JavaScript -->
            </div>
            <div class="map-legend">
                <h4 data-translate="Legend">Legend</h4>
                <ul>
                    @foreach (var site in Model.Sites)
                    {
                        <li>
                            <span class="map-marker-icon"></span>
                            <span data-translate="site-name-@site.Id">@site.Name</span>
                        </li>
                    }
                </ul>
            </div>
